...
from help_code_demo import ToTensor, ECG_DataSET, F1, FB, Sensitivity, Specificity, BAC, ACC, PPV, NPV
from models.model_1 import AFNetWithResidualsAndAttention
def main():
    seed = 222
    ...
    net = AFNetWithResidualsAndAttention()
    net.load_state_dict(torch.load(path_net + 'ECG_net_state_dict.pkl'))
    net.eval()
    net.cuda()
